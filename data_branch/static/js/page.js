...
([function (e, t, n) {
    ...
    n = jQuery, page.initNavbar = function () {
        ...
        }), n(document).on("click", ".nav-link", function () {
            e.removeClass("navbar-open"), n(".backdrop-navbar").remove()
        })
    }
}, function (e, t) {
    ...
    !function (e) {
        ...
        var s = function () {
                ...
                s > 0 ? t.addClass("body-scrolled") : t.removeClass("body-scrolled"),
                // s > i ? t.addClass("navbar-scrolled") : t.removeClass("navbar-scrolled"),
                s > 0 ? t.addClass("navbar-scrolled") : t.removeClass("navbar-scrolled"),
                s > o - 50 ? t.addClass("header-scrolled") : t.removeClass("header-scrolled"),
                e('[data-sticky="true"]').each(function () {
